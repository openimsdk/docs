...
| --------------- | ------------------------------------------------------ | -------- | ------------------------------------------------------- |
| sourcePicture   | [PicBaseInfo](docs/sdks/class/message/pictureInfo.mdx) | Yes       | 原图相关信息                                            |
| bigPicture      | [PicBaseInfo](docs/sdks/class/message/pictureInfo.mdx) | Yes       | 大图相关信息                                            |
| snapshotPicture | [PicBaseInfo](docs/sdks/class/message/pictureInfo.mdx) | Yes       | 缩略图相关信息                                          |
| sourcePath      | string                                                 | Yes       | 图片在本机的绝对路径，如果没有传空字符即可              |
