...
| 名称 | 类型                                                             | 描述     |
| ---- | ---------------------------------------------------------------- | -------- |
| list | List<[ReadReceiptInfo](/class/message/receiptInfo.mdx)> | 已读回执列表 |
...
| 名称        | 类型                                                                    | 描述     |
| ----------- | ----------------------------------------------------------------------- | -------- |
| receiptList | NSArray< [OIMReceiptInfo](/class/message/receiptInfo.mdx) \* > | 已读回执列表 |
...
| 名称 | 类型                                                             | 描述     |
| ---- | ---------------------------------------------------------------- | -------- |
| list | List<[ReadReceiptInfo](/class/message/receiptInfo.mdx)> | 回执列表 |
...
| 名称 | 类型                                                                                              | 描述         |
| ---- | ------------------------------------------------------------------------------------------------- | ------------ |
| data | [WSEvent](/class/response.mdx)<[ReceiptInfo](/class/message/receiptInfo.mdx)[]> | 已读回执列表 |
