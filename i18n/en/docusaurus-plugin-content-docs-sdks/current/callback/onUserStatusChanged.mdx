...
| 名称 | 类型           | 描述     |
| ---- | -------------- | -------- |
| info | [UserStatusInfo](/class/user/userStatusInfo.mdx) | 用户状态信息 |
...
| 名称 | 类型              | 描述         |
| ---- | ----------------- | ------------ |
| info | [OIMUserStatusInfo](/class/user/userStatusInfo.mdx) | 用户状态信息 |
...
| 名称 | 类型                                                    | 描述     |
| ---- | ------------------------------------------------------- | -------- |
| info | [onlineStatus](/class/user/userStatusInfo.mdx) | 用户信息 |
