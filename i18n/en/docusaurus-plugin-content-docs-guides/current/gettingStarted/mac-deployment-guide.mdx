...
For deploying OpenIM using Docker, refer to the instructions provided at [OpenIM Docker Deployment](https://docs.openim.io/zh-hans/guides/gettingstarted/dockercompose). Follow the steps outlined there for a seamless Docker-based deployment.
