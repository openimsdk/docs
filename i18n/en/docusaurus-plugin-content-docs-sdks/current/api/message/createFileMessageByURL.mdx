...
| Parameter Name    | Parameter Type | Mandatory | Description                                                                                                                        |
| ----------- | -------- | -------- | ---------------------------------------------------------------------------------------------------------------------------- |
| filePath    | string   | Yes       | 文件路径，传空字符串即可                                                                                                     |
| fileName    | string   | Yes       | File name称                                                                                                                     |
| uuid        | string   | Yes       | File unique ID                                                                                                                  |
| sourceUrl   | string   | Yes       | 图片下载地址，自行上文件后获得的远程 url 地址，需要通过[sendMessageNotOss](docs/sdks/api/message/sendMessageNotOss.mdx) 发送 |
| fileSize    | string   | Yes       | 文件大小                                                                                                                     |
| fileType    | string   | Yes       | File type，一般为后缀名                                                                                                       |
