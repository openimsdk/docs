...
| Parameter Name  | Parameter Type                                                              | Description         |
| --------------- | --------------------------------------------------------------------------- | ------------------- |
| Promise.then()  | Promise<WsResponse<[PublicInfo](/class/user/publicInfo.mdx)[]>\>       | List of friend info |
...
| Parameter Name  | Parameter Type                                              | Description         |
| --------------- | ----------------------------------------------------------- | ------------------- |
| Promise.then()  | Promise<[PublicInfo](/class/user/publicInfo.mdx)[]\>  | List of friend info |
