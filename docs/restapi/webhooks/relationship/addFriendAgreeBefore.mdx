...
## 回调发生时机
- OpenIM Server 收到来自 App 的加好友回应请求后
...
```plaintext
http://www.example.com/callbackBeforeAddFriendAgreeCommand?contenttype=json
```
...
| CallbackCommand | 此处为：callbackBeforeAddFriendAgreeCommand |
