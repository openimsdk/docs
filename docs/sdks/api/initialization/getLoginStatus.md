...
| 参数名称 | 参数类型 | 描述                                    |
| -------- | -------- | --------------------------------------- |
| ~        | [int](/enum/loginStatus.md)     | 登录状态，1：未登录 2：登录中 3：已登录 |
...
| 参数名称  | 参数类型 | 描述                                    |
| --------- | -------- | --------------------------------------- |
| status | [OIMLoginStatus](/enum/loginStatus.md)   | 登录状态，1：未登录 2：登录中 3：已登录 |
...
| 参数名称 | 参数类型 | 描述                                    |
| -------- | -------- | --------------------------------------- |
| ~        | int      | [LoginStatus](/enum/loginStatus.md) 登录状态 |
...
| 参数名称        | 参数类型                                                            | 描述         |
| --------------- | ------------------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<WsResponse<[LoginStatus](/enum/loginStatus.md)>\> | 登录状态     |
...
| 参数名称        | 参数类型                                                | 描述             |
| --------------- | ------------------------------------------------------- | ---------------- |
| Promise.then()  | Promise<[LoginStatus](/enum/loginStatus.md)\> | 当前用户登录状态 |
