...
| 名称 | 类型                                                             | 描述     |
| ---- | ---------------------------------------------------------------- | -------- |
| list | List<[ReadReceiptInfo](/class/message/receiptInfo.md)> | 已读回执列表 |
...
| 名称        | 类型                                                                    | 描述     |
| ----------- | ----------------------------------------------------------------------- | -------- |
| receiptList | NSArray< [OIMReceiptInfo](/class/message/receiptInfo.md) \* > | 已读回执列表 |
...
| 名称 | 类型                                                             | 描述     |
| ---- | ---------------------------------------------------------------- | -------- |
| list | List<[ReadReceiptInfo](/class/message/receiptInfo.md)> | 回执列表 |
...
| 名称 | 类型                                                                                              | 描述         |
| ---- | ------------------------------------------------------------------------------------------------- | ------------ |
| data | [WSEvent](/class/response.md)<[ReceiptInfo](/class/message/receiptInfo.md)[]> | 已读回执列表 |
...
| 名称 | 类型                                                             | 描述     |
| ---- | ---------------------------------------------------------------- | -------- |
| list | List<[MessageReceipt](/class/message/receiptInfo.md)> | 已读回执列表 |
