...
If the resource has already been uploaded by your application and stored in a URL-based message, use [`sendMessageNotOss()`](/sdk/wasm/message/sending-messages/send-message-not-oss).
