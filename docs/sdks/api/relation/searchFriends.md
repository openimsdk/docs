...
| 参数名称         | 参数类型                                                                                           | 是否必填 | 描述                                           |
| ---------------- | -------------------------------------------------------------------------------------------------- | -------- | ---------------------------------------------- |
| callBack         | [OnBase](/callback/onBase.md)<List<[FriendInfo](/class/relation/friendInfo.md)>> | 是       | 回调接口                                       |
| keywordList      | List<String\>                                                                                      | 是       | 搜索关键词，目前仅支持一个关键词搜索，不能为空 |
...
| 参数名称         | 参数类型                                                                                           | 是否必填 | 描述                                           |
| ---------------- | -------------------------------------------------------------------------------------------------- | -------- | ---------------------------------------------- |
| cb |  [OnBase](/callback/onBase.md)<List<[FriendInfo](/class/relation/friendInfo.md)>> | 是       | 回调|
| searchParam |     [SearchFriendsParam](/class/relation/SearchFriendsParam.md)  | 是       | 搜索参数设置 |
