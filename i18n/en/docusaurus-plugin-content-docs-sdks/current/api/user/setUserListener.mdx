...
After successful initialization, it's set automatically. Callbacks will be passed to the client through `globalEvent`. [Details on user events can be found here](docs/sdks/listener/userListener.mdx)
