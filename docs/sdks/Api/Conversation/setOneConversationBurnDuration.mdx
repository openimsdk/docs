...
```dart showLineNumbers
    await OpenIM.iMManager.conversationManager.setOneConversationBurnDuration(conversationID: conversationID);
    //todo
```
...
[OIMManager.manager setOneConversationBurnDuration:@""
                                          duration:30
