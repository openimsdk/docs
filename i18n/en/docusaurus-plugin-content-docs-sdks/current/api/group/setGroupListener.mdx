...
:::caution 注意
After successful initialization, it's set automatically. Callbacks will be passed to the client through `globalEvent`. [Details on group events can be found here](docs/sdks/listener/groupListener.mdx)
