...
For permissions, result stages, and event payloads, see [Modify a message](/sdk/ios/message/managing-messages/modify-a-message) and [Pin or unpin a message](/sdk/ios/message/managing-messages/set-message-pinned).
