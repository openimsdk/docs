...
| `invitation` | `RtcInvite` (optional) | Original invitation associated with the current room. |
| `participant` | `ParticipantInfo[]` (optional) | Snapshot of participants currently in the room. |
