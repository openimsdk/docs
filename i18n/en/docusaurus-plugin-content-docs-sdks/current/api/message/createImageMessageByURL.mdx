...
通过该api创建的消息必须通过[sendMessageNotOss](/api/message/sendMessageNotOss.mdx)发送。
...
| sourcePicture   | [PictureInfo](/class/message/pictureInfo.mdx) | 是       | 原图相关信息   |
| bigPicture      | [PictureInfo](/class/message/pictureInfo.mdx) | 是       | 大图相关信息   |
| snapshotPicture | [PictureInfo](/class/message/pictureInfo.mdx) | 是       | 缩略图相关信息 |

### 返回结果

| 名称 | 类型                                               | 描述     |
| ---- | -------------------------------------------------- | -------- |
| ~    | [Message](/class/message/messageInfo.mdx) | 成功返回 |
...
| -------- | --------------------------------------------------------- | -------- | -------------- |
| sourcePath   | String | 是       | 图片在本机的绝对路径，如果没有传空字符即可    |
| source   | [OIMPictureInfo](/class/message/pictureInfo.mdx) | 是       | 原图相关信息   |
| big      | [OIMPictureInfo](/class/message/pictureInfo.mdx) | 是       | 大图相关信息   |
| snapshot | [OIMPictureInfo](/class/message/pictureInfo.mdx) | 是       | 缩略图相关信息 |

### 返回结果

| 名称    | 类型                                                      | 描述     |
| ------- | --------------------------------------------------------- | -------- |
| message | [OIMMessageInfo](/class/message/messageInfo.mdx) | 成功返回 |
...
| 参数名称        | 参数类型                                               | 是否必填 | 描述                                       |
| --------------- | ------------------------------------------------------ | -------- | ------------------------------------------ |
| sourcePicture   | [PicBaseInfo](/class/message/pictureInfo.mdx) | 是       | 原图相关信息                               |
| bigPicture      | [PicBaseInfo](/class/message/pictureInfo.mdx) | 是       | 大图相关信息                               |
| snapshotPicture | [PicBaseInfo](/class/message/pictureInfo.mdx) | 是       | 缩略图相关信息                             |
| sourcePath      | string                                                 | 是       | 图片在本机的绝对路径，如果没有传空字符即可 |
...
| 参数名称        | 参数类型                                                                     | 描述         |
| --------------- | ---------------------------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<WsResponse<[MessageItem](/class/message/messageInfo.mdx)>\> | 调用成功回调 |
...
| 参数名称        | 参数类型                                                         | 描述         |
| --------------- | ---------------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<[MessageItem](/class/message/messageInfo.mdx)\> | 调用成功回调 |
