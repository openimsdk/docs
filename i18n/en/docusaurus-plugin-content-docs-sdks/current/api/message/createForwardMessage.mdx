...
| 参数名称 | 参数类型                                           | 是否必填 | 描述           |
| -------- | -------------------------------------------------- | -------- | -------------- |
| message  | [Message](/class/message/messageInfo.mdx) | 是       | 需要转发的消息 |
...
| 参数名称 | 参数类型                                                  | 是否必填 | 描述           |
| -------- | --------------------------------------------------------- | -------- | -------------- |
| msg      | [OIMMessageInfo](/class/message/messageInfo.mdx) | 是       | 需要转发的消息 |
...
| -------- | ------------------------------------------------------ | -------- | ------------ |
| text     | string                                                 | 是       | 文本内容     |
| message  | [MessageItem](/class/message/messageInfo.mdx) | 是       | 被转发的消息 |
...
| message     | [MessageItem](/class/message/messageInfo.mdx) | 是       | 要转发的消息                                            |
