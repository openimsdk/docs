...
In OpenIM Enterprise, pass `searchText` when the custom message should participate in local message search. It supplies searchable text only and does not replace the business payload:
