# Use Linux system for production deployment
...
##  1. <a name='Deployment'></a>Deployment

1. **Retrieve the Installation Script**:

   Clone OpenIM in localhost:
...
2. **Filtering Logs**:
   ...
   + Most Recent Logs: To view the most recent logs, you can combine 
