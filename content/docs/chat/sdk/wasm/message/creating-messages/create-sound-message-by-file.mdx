...
Derive the audio size, type, and duration from the actual file. When the Promise resolves, it has created only a pending message object. Use `sendMessage()` afterward to upload and send it.
