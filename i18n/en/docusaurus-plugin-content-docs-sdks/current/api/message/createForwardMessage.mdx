...
| Parameter Name    | Parameter Type                                               | Mandatory | Description                                                   |
| ----------- | ------------------------------------------------------ | -------- | ------------------------------------------------------- |
| message     | [MessageItem](docs/sdks/class/message/messageInfo.mdx) | Yes       | 要转发的消息                                            |
...
const message = {...} as MessageItem;
try {
        const data = await OpenIMSDKRN.createForwardMessage(message,operationID: "operationID");
        console.log("createForwardMessage", data);
    }
    catch (error) {
        console.error('Error createForwardMessage:', error); // Log the error
    }
```
