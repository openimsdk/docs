...
| 参数 | 类型 | 说明 |
| --- | --- | --- |
| `filePath` | <code>string &#124; null</code> | 文件的本地名称或业务路径；只有远端资源时传空字符串。 |
| `fileName` | <code>string &#124; null</code> | 对外展示的文件名。 |
| `uuid` | <code>string &#124; null</code> | 文件资源的唯一标识。 |
| `sourceUrl` | <code>string &#124; null</code> | 已上传文件的可访问地址。 |
| `fileSize` | <code>number &#124; null</code> | 文件大小，单位为字节。 |
