...
| 名称 | 类型                                                          | 描述     |
| ---- | ------------------------------------------------------------- | -------- |
| info | [GroupMembersInfo](/class/group/groupMemberInfo.mdx) | 群成员信息 |
...
| 名称       | 类型                                                            | 描述     |
| ---------- | --------------------------------------------------------------- | -------- |
| memberInfo | [OIMGroupMemberInfo](/class/group/groupMemberInfo.mdx) | 群成员信息 |
...
| 名称 | 类型                                                          | 描述     |
| ---- | ------------------------------------------------------------- | -------- |
| info | [GroupMembersInfo](/class/group/groupMemberInfo.mdx) | 好友信息 |
...
| 名称 | 类型                                                                                                  | 描述       |
| ---- | ----------------------------------------------------------------------------------------------------- | ---------- |
| data | [WSEvent](/class/response.mdx)<[GroupMemberItem](/class/group/groupMemberInfo.mdx)> | 群成员信息 |
