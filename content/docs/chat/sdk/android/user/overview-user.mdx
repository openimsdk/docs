...
| `UserInfo`              | User object returned by friend-list, friend-profile, or blocklist queries; it can include relationship data | `getFriendListPage()`, `getFriendsInfo()`, `getBlacklist()`       |
