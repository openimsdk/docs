...
After successful initialization, it's set automatically. You can directly use the listener on the client side. [Details on message events can be found here](/listener/batchMsgListener.mdx)
...
| -------- | ------------------------------------------------------------------- | ---- | --- |
| l | [OnAdvancedMsgListener](/listener/advancedMsgListener.mdx) |Yes  |     |
