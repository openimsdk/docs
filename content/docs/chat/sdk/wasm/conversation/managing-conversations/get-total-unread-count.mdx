...
The query itself does not trigger an event. While the application is in the foreground, this page exclusively handles `SdkEvent.OnTotalUnreadMessageCountChanged`:
