...
Promise completion, `OnGroupInfoChanged` delivery, and a reconciliation query are three stages. See [Group overview](/sdk/wasm/group/overview-group) for event merging.
