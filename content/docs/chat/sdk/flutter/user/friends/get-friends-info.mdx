...
This query does not trigger the friendship listener. If you only need to check relationship state, see [Check friendship status](/sdk/flutter/user/friends/check-friend).
