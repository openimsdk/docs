...
| fileName    | string   | Yes       | File name称                                                |
...
import OpenIMSDKRN from "open-im-sdk-rn";
   try {
        const data = await OpenIMSDKRN.createFileMessageFromFullPath({
          filePath: '',
          fileName: '',
        },operationID: "operationID");
        console.log("createFileMessageFromFullPath", data);
    }
    catch (error) {
        console.error('Error createFileMessageFromFullPath:', error); // Log the error
    }
```
