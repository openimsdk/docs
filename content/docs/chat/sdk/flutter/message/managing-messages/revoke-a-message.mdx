...
Recalling a message causes other clients to display the original message in a recalled state. OpenIMServer validates the message state, operator, and allowed recall window.
