...
| 参数名称 | 参数类型                                            | 描述     |
| -------- | --------------------------------------------------- | -------- |
| ~        | List<[BlacklistInfo](/class/relation/blackInfo.md)> | 成功返回 |
...
| 参数名称  | 参数类型                                                           | 描述     |
| --------- | ------------------------------------------------------------------ | -------- |
| onSuccess | NSArray< [OIMBlackInfo](/class/relation/blackInfo.md) \* > | 成功返回 |
...
| 参数名称 | 参数类型                                                                                     | 是否必填 | 描述     |
| -------- | -------------------------------------------------------------------------------------------- | -------- | -------- |
| callBack | [OnBase](/callback/onBase.md)<List<[UserInfo](/class/user/userInfo.md)>> | 是       | 回调接口 |
...
| 参数名称        | 参数类型                                                                      | 描述               |
| --------------- | ----------------------------------------------------------------------------- | ------------------ |
| Promise.then()  | Promise<WsResponse<[BlackUserItem](/class/relation/blackInfo.md)[]>\> | 黑名单信息对象列表 |
...
| 参数名称        | 参数类型                                                          | 描述               |
| --------------- | ----------------------------------------------------------------- | ------------------ |
| Promise.then()  | Promise<[BlackUserItem](/class/relation/blackInfo.md)[]\> | 黑名单信息对象列表 |
...
| 参数名称 | 参数类型                                                                                     | 是否必填 | 描述     |
| -------- | -------------------------------------------------------------------------------------------- | -------- | -------- |
| cb |  [OnBase](/callback/onBase.md)<List<[BlackInfo](/class/relation/blackInfo.md)>> | 是       | 回调|
