...
| 参数名称      | 参数类型                                         | 是否必填 | 描述           |
| ------------- | ------------------------------------------------ | -------- | -------------- |
| groupInfo     | [GroupInfo](/class/group/groupInfo.mdx) | 是       | 群信息         |
...
| 参数名称 | 参数类型                                         | 描述     |
| -------- | ------------------------------------------------ | -------- |
| ~        | [GroupInfo](/class/group/groupInfo.mdx) | 成功返回 |
...
| 参数名称        | 参数类型                                                                         | 是否必填 | 描述   |
| --------------- | -------------------------------------------------------------------------------- | -------- | ------ |
| groupCreateInfo | [OIMGroupCreateInfo](/class/group/groupInfo.mdx)                        | 是       | 创建群的初始化信息 |

### 返回结果

| 参数名称  | 参数类型                                             | 描述     |
| --------- | ---------------------------------------------------- | -------- |
| onSuccess | [OIMGroupInfo](/class/group/groupInfo.mdx)  | 成功返回 |
...
| 参数名称      | 参数类型                                             | 是否必填 | 描述                       |
| ------------- | ---------------------------------------------------- | -------- | -------------------------- |
| groupInfo     | [GroupInitInfo](/class/group/groupInfo.mdx) | 是       | 群聊基础信息               |
| memberUserIDs | string[]                                             | 是       | 邀请进入的群成员列表       |
| adminUserIDs  | string[]                                             | 否       | 邀请进入并设为管理员的列表 |
| ownerUserID   | string                                               | 否       | 群主 ID                    |
| callBack     | [OnBase](/callback/onBase.mdx)<[GroupInfo](/class/group/groupInfo.mdx)> | 是       | 回调接口                   |
...
| 参数名称      | 参数类型                                             | 是否必填 | 描述                       |
| ------------- | ---------------------------------------------------- | -------- | -------------------------- |
| groupInfo     | Partial<[GroupItem](/class/group/groupInfo.mdx)> | 是       | 群聊基础信息               |
| memberUserIDs | string[]                                             | 是       | 邀请进入的群成员列表       |
| adminUserIDs  | string[]                                             | 否       | 邀请进入并设为管理员的列表 |
| ownerUserID   | string                                               | 否       | 群主 ID                    |
...
| 参数名称        | 参数类型                                                              | 描述         |
| --------------- | --------------------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<WsResponse<[GroupItem](/class/group/groupInfo.mdx)>> | 调用成功回调 |
...
| 参数名称        | 参数类型                                                   | 描述         |
| --------------- | ---------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<[GroupItem](/class/group/groupInfo.mdx)\> | 调用成功回调 |
