...
const DyteLeaveButton = class {
  constructor(hostRef) {
    ...
    this.leave = () => {
      ...
      _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_3__.s.activeLeaveConfirmation = true;
    };
    this.variant = 'button';
    this.size = undefined;
  ...
  render() {
    ...
    return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, { label: text }, (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { size: this.size, iconPack: this.iconPack, t: this.t, class: "leave", onClick: this.leave, icon: this.iconPack.call_end, label: text, variant: this.variant })));
  }
};
