...
| 参数名称        | 参数类型                                                                        | 描述         |
| --------------- | ------------------------------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<WsResponse<[FriendUserItem](/class/friend/friendInfo.mdx)[]>\> | 好友信息列表 |
...
| 参数名称        | 参数类型                                                            | 描述         |
| --------------- | ------------------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<[FriendUserItem](/class/friend/friendInfo.mdx)[]\> | 好友信息列表 |
