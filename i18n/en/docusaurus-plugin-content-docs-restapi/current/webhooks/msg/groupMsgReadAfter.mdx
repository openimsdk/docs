---
title: Callback After Group Chat Message Read Report
hide_title: true
---
...
## Description
The App backend can use this callback to view the read status of users' Group Chat messages in real-time.
...
- An App user reports a Group Chat message as read through the client.
- An administrator sets a Group Chat message as read through the REST API.

## Timing of Callback
- After a Group Chat message is successfully marked as read.
...
|-------------------|------------|-----------------------------------------|
| callbackCommand   | string     | Callback command for the Group Chat message read report |
...
### Success Response
The backend successfully receives and processes the Group Chat message read report.
