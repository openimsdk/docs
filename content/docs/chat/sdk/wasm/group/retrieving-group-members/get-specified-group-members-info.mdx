...
This query does not trigger member events. See [List group members](/sdk/wasm/group/retrieving-group-members/get-group-member-list) for how to handle later member changes.
