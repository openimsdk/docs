...
| 参数名称 | 参数类型                                         | 是否必填 | 描述     |
| -------- | ------------------------------------------------ | -------- | -------- |
| fileElem | [FileElem](/class/message/fileElem.md) | 是       | 绝对路径 |
...
| fileName    | string   | 是       | 文件名称                                                                                                                     |
| uuid        | string   | 是       | 文件唯一 ID                                                                                                                  |
| sourceUrl   | string   | 是       | 图片下载地址，自行上文件后获得的远程 url 地址，需要通过[sendMessageNotOss](/api/message/sendMessageNotOss.md) 发送 |
| fileSize    | string   | 是       | 文件大小                                                                                                                     |
| fileType    | string   | 是       | 文件类型，一般为后缀名                                                                                                       |
