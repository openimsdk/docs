...
Commit the dependency lockfile for team projects. After upgrading the package, verify initialization, sign-in, asset loading, sending, and receiving again.
