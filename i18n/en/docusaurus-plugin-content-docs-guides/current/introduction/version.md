...
## 2. Use GitHub Releases as the Version Source of Truth
...
> Do not use versions marked `Pre-release`, and do not use `alpha`, `beta`, `rc`, or `main` directly in production.
...
## 3. Production Version Selection Recommendations
...
## 4. How to Check the Current Latest Stable Release
