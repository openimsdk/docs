...
| 参数名称       | 参数类型                                                                   | 是否必填 | 描述                                                                                                           |
| -------------- | -------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------- |
| callBack       | [OnGetAdvancedHistoryMessageList](/callback/OnGetAdvancedHistoryMessageList.mdx) | 是       | 回调接口                                                                                                       |
| getMessageOptions |     [GetAdvancedHistoryMessageListParams](/class/message/GetAdvancedHistoryMessageListParams.mdx)                                                               | 是       | 选项                                                                                                           |
