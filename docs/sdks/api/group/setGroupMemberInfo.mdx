...
| 参数名称         | 参数类型                                                        | 是否必填 | 描述     |
| ---------------- | --------------------------------------------------------------- | -------- | -------- |
| groupMembersInfo | [OIMGroupMemberInfo](docs/sdks/class/group/groupMemberInfo.mdx) | 是       | 成员信息 |
...
- (void)setGroupMemberInfo:(OIMGroupMemberInfo *)groupMembersInfo
...
try {
  ...
  await OpenIMSDKRN.setGroupMemberInfo(data, operationID);

  console.log("setGroupMemberInfo: Updated group member info with data", data);
} catch (error) {
  console.error('Error setGroupMemberInfo:', error);
}
...
| 参数名称 | 参数类型 | 是否必填 | 描述         |
| -------- | -------- | -------- | ------------ |
| cb | [OnSucOrError](docs/sdks/callback/OnSucOrError.mdx) | 是       | 回调    |
| groupMemberInfo| [SetGroupMemberInfo](docs/sdks/class/group/SetGroupMemberInfo.mdx) | 是       |  成员设置
