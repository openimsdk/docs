...
| content             | object | Detailed content of the message, internally a JSON object. For other message types, refer to the [Message Type Format Description](docs/restapi/contentDescription.mdx) document |
