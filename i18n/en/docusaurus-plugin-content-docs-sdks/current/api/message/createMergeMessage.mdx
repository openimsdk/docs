...
| 参数名称    | 参数类型                                                 | 是否必填 | 描述         |
| ----------- | -------------------------------------------------------- | -------- | ------------ |
| messageList | List<[Message](/class/message/messageInfo.mdx)> | 是       | 消息列表     |
| title       | String                                                   | 是       | 标题         |
...
| 参数名称 | 参数类型                                                                 | 是否必填 | 描述         |
| -------- | ------------------------------------------------------------------------ | -------- | ------------ |
| messages | NSArray < [OIMMessageInfo](/class/message/messageInfo.mdx) \* > | 是       | 消息列表     |
| title    | NSString                                                                 | 是       | 标题         |
...
| 参数名称    | 参数类型                                                 | 是否必填 | 描述         |
| ----------- | -------------------------------------------------------- | -------- | ------------ |
| messageList | [MessageItem](/class/message/messageInfo.mdx)[] | 是       | 消息列表     |
| title       | string                                                   | 是       | 标题         |
