...
A successful Promise means that the update request has completed. Merge the final profiles from `OnFriendInfoChanged` by `userID`. See [Get the friend list](/sdk/wasm/user/friends/get-friend-list-page) for the complete listener.
