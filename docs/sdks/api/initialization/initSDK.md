...
| 参数名称 | 参数类型                                         | 是否必填 | 描述       |
| -------- | ------------------------------------------------ | -------- | ---------- |
| config   | [InitConfig](/class/init/config.md) | 是       | 初始化参数 |
...
| 参数名称 | 参数类型                                         | 是否必填 | 描述       |
| -------- | ------------------------------------------------ | -------- | ---------- |
| config   | [OIMInitConfig](/class/init/config.md) | 是       | 初始化参数 |
...
| initConfig               | [InitConfig](/class/init/config.md)                                                     | 是       | 初始化参数         |
| listener             | [OnConnectListener](/listener/connectListener.md) | 是       | 监听                  |
...
| 参数名称  | 参数类型     | 是否必填 | 描述                                                   |
| -------- | ----------- | -------- | -------------------------------------------------------|
| config   | [IMConfig](/class/init/config.md)    |   是     | SDK配置           |
|  cb      | [IConnListener](/listener/connectListener.md)   |   是     | 网络连接状态回调   |
