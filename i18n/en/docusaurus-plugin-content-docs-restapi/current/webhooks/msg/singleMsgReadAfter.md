---
title: Callback After Reporting Single Chat Message Read
hide_title: true
---

# Callback After Reporting Single Chat Message Read

## Functional Description
The App business server can view the read actions of users' single chat messages in real-time through this callback.
...
## Timing of Callback
- After successfully reporting single chat messages as read.
...
|-----------------|--------|----------------------------|
| callbackCommand | string | Callback command, here it is the single chat message read callback           |
...
### Successful Response
Successfully received and processed the user's request to read single chat messages.
