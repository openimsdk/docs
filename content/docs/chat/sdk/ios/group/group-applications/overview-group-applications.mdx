...
This section documents received applications, sent applications, unhandled counts, acceptance, rejection, and record deletion separately. The iOS SDK has no dedicated selector for querying or clearing a server-side badge.
