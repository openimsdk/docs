...
- Runtime logs, for troubleshooting after successful startup: `{openim-server, openim-chat}/logs/OpenIM.log.all.*`
- Startup logs, for checking in case of errors during startup: `{openim-server, openim-chat}/_output/logs/openim_*.log`