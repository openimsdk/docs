...
创建图片消息，由SDK内部根据全路径提取图片信息并创建图片消息。
...
Web端建议使用[createImageMessageByURL](/api/message/createImageMessageByURL.mdx)或[createImageMessageByFile](/api/message/createImageMessageByFile.mdx)。
