...
After a user initiates a group join application, if approval is required to join, the applicant and the group owner/administrators receive this callback.
