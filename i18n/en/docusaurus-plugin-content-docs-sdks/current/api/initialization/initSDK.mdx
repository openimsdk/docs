...
| 参数名称 | 参数类型                                         | 是否必填 | 描述       |
| -------- | ------------------------------------------------ | -------- | ---------- |
| config   | [InitConfig](/class/init/config.mdx) | 是       | 初始化参数 |
...
| 参数名称 | 参数类型                                         | 是否必填 | 描述       |
| -------- | ------------------------------------------------ | -------- | ---------- |
| config   | [OIMInitConfig](/class/init/config.mdx) | 是       | 初始化参数 |
...
| initConfig               | [InitConfig](/class/init/config.mdx)                                                     | 是       | 初始化参数         |
| listener             | [OnConnectListener](/listener/connectListener.mdx) | 是       | 监听                  |
