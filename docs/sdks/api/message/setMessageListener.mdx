...
登录成功后自动设置，可以直接在客户端使用监听，[消息事件详情参见](docs/sdks/listener/advancedMsgListener.mdx)
...
初始化成功后自动设置 回调会通过`globalEvent`传递到客户端，[消息事件详情参见](docs/sdks/listener/advancedMsgListener.mdx)
...
| 参数名称 | 参数类型                                                            | 描述 |
| -------- | ------------------------------------------------------------------- | ---- | --- |
| l | [OnAdvancedMsgListener](docs/sdks/listener/advancedMsgListener.mdx) | 是   |     |
