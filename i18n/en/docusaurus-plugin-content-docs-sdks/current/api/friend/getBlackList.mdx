...
| 参数名称  | 参数类型                                                           | 描述     |
| --------- | ------------------------------------------------------------------ | -------- |
| onSuccess | NSArray< [OIMBlackInfo](/class/friend/blackInfo.mdx) \* > | 成功返回 |
...
| 参数名称        | 参数类型                                                                      | 描述               |
| --------------- | ----------------------------------------------------------------------------- | ------------------ |
| Promise.then()  | Promise<WsResponse<[BlackUserItem](/class/friend/blackInfo.mdx)[]>\> | 黑名单信息对象列表 |
...
| 参数名称        | 参数类型                                                          | 描述               |
| --------------- | ----------------------------------------------------------------- | ------------------ |
| Promise.then()  | Promise<[BlackUserItem](/class/friend/blackInfo.mdx)[]\> | 黑名单信息对象列表 |
