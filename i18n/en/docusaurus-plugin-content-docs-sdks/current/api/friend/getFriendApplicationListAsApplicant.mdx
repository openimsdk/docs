...
| 参数名称 | 参数类型                                                                    | 描述     |
| -------- | --------------------------------------------------------------------------- | -------- |
| ~        | List<[FriendApplicationInfo](/class/friend/friendApplication.mdx)> | 成功返回 |
...
| 参数名称  | 参数类型                                                                           | 描述     |
| --------- | ---------------------------------------------------------------------------------- | -------- |
| onSuccess | NSArray< [OIMFriendApplication](/class/friend/friendApplication.mdx) \* > | 成功返回 |
...
| 参数名称 | 参数类型                                                                                                             | 是否必填 | 描述     |
| -------- | -------------------------------------------------------------------------------------------------------------------- | -------- | -------- |
| callBack | [OnBase](/callback/onBase.mdx)<List<[FriendApplicationInfo](/class/friend/friendApplication.mdx)>> | 是       | 回调接口 |
...
| 参数名称        | 参数类型                                                                                      | 描述               |
| --------------- | --------------------------------------------------------------------------------------------- | ------------------ |
| Promise.then()  | Promise<WsResponse<[FriendApplicationItem](/class/friend/friendApplication.mdx)[]>\> | 发出的好友请求列表 |
...
| 参数名称        | 参数类型                                                                          | 描述               |
| --------------- | --------------------------------------------------------------------------------- | ------------------ |
| Promise.then()  | Promise<[FriendApplicationItem](/class/friend/friendApplication.mdx)[]\> | 发出的好友请求列表 |
