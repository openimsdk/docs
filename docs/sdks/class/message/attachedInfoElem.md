...
| 字段名称 | 字段类型 | 描述 | | ---------------- | ---------------------------------------------------------------- | ---------------------------------- |
| groupHasReadInfo | [GroupHasReadInfo](/class/message/groupHasReadInfo.md) | 群消息已读信息 |
...
| 字段名称          | 字段类型                                                            | 描述                               |
| ----------------- | ------------------------------------------------------------------- | ---------------------------------- |
| groupHasReadInfo  | [OIMGroupHasReadInfo](/class/message/groupHasReadInfo.md) | 群消息已读信息                     |
| isPrivateChat     | BOOL                                                                | 标识是否为阅后即焚消息，仅支持单聊 |
