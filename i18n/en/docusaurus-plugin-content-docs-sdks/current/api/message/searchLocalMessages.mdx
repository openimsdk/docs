...
| Parameter Name             | Parameter Type                                                             | Mandatory | Description                                                                                            |
| -------------------- | -------------------------------------------------------------------- | -------- | -----------------------------|
| cb | [OnSearchLocalMessagesCallback](/callback/OnSearchLocalMessagesCallback.mdx) |Yes      | Callback                                |
| searchParam | [SearchLocalMessagesParams](/class/message/SearchLocalMessagesParams.mdx) |Yes      | Search Setting |
