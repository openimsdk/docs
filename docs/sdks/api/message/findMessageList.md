...
| findResultItems | List<[SearchResultItems](/class/message/searchResultItem.md)> | 搜索结果 调用 findXX 方法返回 |
...
| 参数名称           | 参数类型                                                           | 是否必填 | 描述     |
| ------------------ | ------------------------------------------------------------------ | -------- | -------- |
| cb |  [OnBase](/callback/onBase.md)< FindMessageResult>  | 是       | 回调接口                                                                                        |
| findMessageOptions | [ConversationArgs](/class/message/ConversationArgs.md)[] | 是       |          |
...
| ----------------- | ------------------------------------------------------------------------------------- | -------------------- |
| TotalCount  | int | 获取到的总的消息数量 |
| FindResultItems | List< [SearchResultItem](/class/message/searchResultItem.md)  > | 搜索结果             |
