...
发送成功 callback 返回值可能为空；非空时按 `clientMsgID` 替换本地待发送项。完整参数与错误处理见[发送消息](/sdk/ios/message/sending-messages/send-a-message)，媒体组合见[创建媒体与富消息](/sdk/ios/message/sending-messages/create-media-and-rich-messages)。
...
相关页面包括[转发或合并消息](/sdk/ios/message/managing-messages/forward-or-merge-a-message)、[修改消息](/sdk/ios/message/managing-messages/modify-a-message)、[置顶或取消置顶消息](/sdk/ios/message/managing-messages/set-message-pinned)、[删除消息](/sdk/ios/message/managing-messages/delete-saved-message)、[撤回消息](/sdk/ios/message/managing-messages/revoke-a-message)、[插入本地单聊消息](/sdk/ios/message/managing-messages/insert-local-single-message)、[清理全部本地消息](/sdk/ios/message/managing-messages/clear-all-local-messages)和[上报输入状态](/sdk/ios/message/composing-messages/update-typing-status)。
...
相关流程见[在消息中提及用户](/sdk/ios/message/composing-messages/mention-users-in-a-message)。
...
相关流程见[自定义消息与扩展数据](/sdk/ios/message/composing-messages/custom-message-and-extra-data)。
...
完整权限、结果阶段和事件载荷见[修改消息](/sdk/ios/message/managing-messages/modify-a-message)与[置顶或取消置顶消息](/sdk/ios/message/managing-messages/set-message-pinned)。
