...
|content   |No      |object|Specific message content, internally a json object. For detailed fields of other messages, refer to [Message Type Format Description](docs/restapi/contentDescription.mdx) document|
|contentType|No   |int   |[Message Type](docs/restapi/contentDescription.mdx)|
