...
| -------------- | -------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| videoPath      | string   | Yes       | 文件路径，传空字符串即可                                                                                                                    |
| duration       | number   | Yes       | 视频时长                                                                                                                                    |
| videoType      | string   | Yes       | File type，一般为后缀名                                                                                                                      |
| snapshotPath   | string   | Yes       |                                                                                                                                             | 视频封面图路径，传空字符串即可 |
| videoUUID      | string   | Yes       | 视频File unique id                                                                                                                             |
| videoUrl       | string   | Yes       | 视频下载地址，自行上传并通过[sendMessageNotOss](docs/sdks/api/message/sendMessageNotOss.mdx) 发送时，需要传入远程 url，No则为空字符串       |
| videoSize      | number   | Yes       | 文件大小                                                                                                                                    |
| snapshotUUID   | string   | Yes       | 视频封面唯一 id                                                                                                                             |
| snapshotSize   | number   | Yes       | 视频封面图大小                                                                                                                              |
| snapshotUrl    | string   | Yes       | 视频封面图下载地址，自行上传并通过[sendMessageNotOss](docs/sdks/api/message/sendMessageNotOss.mdx) 发送时，需要传入远程 url，No则为空字符串 |
| snapshotWidth  | number   | Yes       | 视频缩略图宽度                                                                                                                              |
| snapshotHeight | number   | Yes       | 视频缩略图高度                                                                                                                              |
| snapShotType   | string   | Yes       | 视频缩略图类型，一般为后缀名                                                                                                                |                                |
