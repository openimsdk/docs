...
| revokerRole                 | [OIMGroupMemberRole](/enum/roleLevel.mdx)         | 撤回者群角色   |
...
| revokerID                   | String   | 撤回者 ID      |
| revokerNickname             | String   | 撤回者昵称     |
| revokerRole                 | int      | [RevokerRole](/enum/roleLevel.mdx) 撤回者群角色   |
| clientMsgID                 | String   | 消息 ID        |
| revokeTime                  | int      | 撤回时间       |
| sourceMessageSendTime       | int      | 消息发送时间   |
| sourceMessageSendID         | String   | 消息发送者     |
| sourceMessageSenderNickname | String   | 消息发送者昵称 |
| sessionType                 | int      | [ConversationType](/enum/conversationType.mdx) 会话类型       |
