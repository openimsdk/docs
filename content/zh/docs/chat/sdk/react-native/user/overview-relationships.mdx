...
| 分页、搜索或按 ID 查询好友关系 | [获取好友列表](/sdk/react-native/user/friends/get-friend-list-page)、[搜索好友](/sdk/react-native/user/friends/search-friends)、[获取好友资料](/sdk/react-native/user/friends/get-specified-friends-info) |
| 检查好友关系 | [检查好友关系](/sdk/react-native/user/friends/check-friend) |
| 更新或删除好友关系 | [更新好友信息](/sdk/react-native/user/friends/update-friends)、[删除好友](/sdk/react-native/user/friends/delete-friend) |
| 发送或处理好友申请 | [发送好友申请](/sdk/react-native/user/friend-applications/add-friend)、[获取收到的好友申请](/sdk/react-native/user/friend-applications/get-friend-application-list-as-recipient)、[同意好友申请](/sdk/react-native/user/friend-applications/accept-friend-application)、[拒绝好友申请](/sdk/react-native/user/friend-applications/refuse-friend-application) |
...
- 好友关系和好友资料变化见[获取好友列表](/sdk/react-native/user/friends/get-friend-list-page)。
