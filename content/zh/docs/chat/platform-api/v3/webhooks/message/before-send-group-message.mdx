---
title: "发送群聊消息前"
description: "OpenIM Webhooks：在群聊消息发送前执行内容审核、拦截或字段检查。"
...
version: "v3"
sourcePath: "/docs/chat/platform-api/v3/webhooks/message/before-send-group-message"
---

在群聊消息发送前执行内容审核、拦截或字段检查。
...
| -------- | ----------------------------------- |
| 类型     | 前置回调                            |
| 配置项   | `beforeSendGroupMsg`                |
| 回调命令 | `callbackBeforeSendGroupMsgCommand` |
