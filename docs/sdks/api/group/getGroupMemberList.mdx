...
| filter   | [int](docs/sdks/enum/groupMemberFilter.mdx)      | 是       | 过滤群成员角色 0 所有，1 群主 , 2 管理员，3 普通成员，4 管理员+普通成员 5,群主+管理员 |
...
| filter   | [OIMGroupMemberFilter](docs/sdks/enum/groupMemberFilter.mdx) | 是       | 过滤群成员角色 |
