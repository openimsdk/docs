...
- If you are using the [pure JS version SDK](/sdks/quickstart/miniProgram), besides deploying `OpenIM Server`, you also need to deploy [OIMWS](https://github.com/openim-sigs/oimws).
