...
针对图片、语音、视频、文件等消息类型，需要先[上传文件](./apis/uploadManagement/initUpload.mdx)，获取下载地址后再发送消息。
...
|      width      |  是  |  int   | 图片宽度                                                               |
|     height      |  是  |  int   | 图片高度                                                               |
|       url       |  是  | string | 图片下载地址，需要先[上传文件](./apis/uploadManagement/initUpload.mdx) |
...
| sourceUrl |  是  | string | 语音文件下载地址，需要先[上传文件](./apis/uploadManagement/initUpload.mdx) |
...
|    videoUrl    |  是  | string | 视频文件下载地址，需要先[上传文件](./apis/uploadManagement/initUpload.mdx)       |
...
|  snapshotUrl   |  是  | string | 视频封面图文件下载地址，需要先[上传文件](./apis/uploadManagement/initUpload.mdx) |
...
| sourceUrl |  是  | string | 文件下载地址，需要先[上传文件](./apis/uploadManagement/initUpload.mdx) |
