...
|groupInfo|Required|object|[Group Information](/en/restapi/commonFields#groupinfo) list|
...
|groupInfo|object|[Group Information](/en/restapi/commonFields#groupinfo) list|
