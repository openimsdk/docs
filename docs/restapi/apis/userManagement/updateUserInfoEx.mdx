...
### 简要描述
- 修改用户的头像、昵称。（如果使用此接口，请使用 **[更新用户信息Ex之前的回调](docs/restapi/webhooks/user/updateUserInfoExBefore.mdx)** 和 **[更新用户信息Ex之后的回调](docs/restapi/webhooks/user/updateUserInfoExAfter.mdx)**。）
### 请求方式
- `post` 
### 请求URL
