...
:::caution 注意
（1）当收到来自 SDK 的[onKickedOffline](/callback/onKickedOffline.md)和[onUserTokenExpired](/callback/onUserTokenExpired.md)时，意味着被踢下线、token无效或者token过期，       
...
| 参数名称 | 参数类型                                | 是否必填 | 描述     |
| -------- | --------------------------------------- | -------- | -------- |
| cb       | [onBase](/callback/onBase.md)  | 是       | 失败成功回调 |
