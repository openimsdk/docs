...
/* harmony import */ var _size_6e369dfd_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(49179);
...
/* harmony import */ var _user_prefs_f52d234f_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(85114);
/* harmony import */ var _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(46503);
/* harmony import */ var _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(36677);
/* harmony import */ var _livestream_8c64d895_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(24555);
/* harmony import */ var _default_icon_pack_a3227c63_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(96633);
/* harmony import */ var _isObjectLike_b5266db7_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(49797);
/* harmony import */ var _pipStore_5d9dd8bf_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(21237);
/* harmony import */ var _breakout_rooms_def907fe_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(19656);
/* harmony import */ var _flags_33c46e09_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(27637);
/* harmony import */ var _graceful_storage_33bc316d_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(60804);
...
const DyteMeeting = class {
  constructor(hostRef) {
    ...
    this.roomJoinedListener = () => {
      ...
      _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.meeting = 'joined';
    };
    this.waitlistedListener = () => {
      this.setStates({ meeting: 'waiting' });
      _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.meeting = 'waiting';
    };
    this.roomLeftListener = ({ state: state$1 }) => {
      const states = this.states || _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s;
      if ((states === null || states === void 0 ? void 0 : states.roomLeftState) === 'disconnected') {
        this.setStates({ meeting: 'ended', roomLeftState: state$1 });
        _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.meeting = 'ended';
        return;
      }
      this.setStates({ meeting: 'ended', roomLeftState: state$1 });
      _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.meeting = 'ended';
      _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.roomLeftState = state$1;
    };
    this.mediaPermissionUpdateListener = ({ kind, message }) => {
      if (['audio', 'video'].includes(kind)) {
        ...
        _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.activePermissionsMessage = permissionModalSettings;
      }
    };
    this.joinStateAcceptedListener = () => {
      this.setStates({ activeJoinStage: true });
      this.stateUpdate.emit({ activeJoinStage: true });
      _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.activeJoinStage = true;
    };
    ...
    this.iconPack = _default_icon_pack_a3227c63_js__WEBPACK_IMPORTED_MODULE_10__.d;
  }
  connectedCallback() {
    var _a;
    this.resizeObserver = new _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_8__.i(() => this.handleResize());
  ...
  meetingChanged(meeting) {
    ...
    if (this.loadConfigFromPreset && meeting.self.config != null) {
      ...
      const { config, data } = (0,_config_ab9d504f_js__WEBPACK_IMPORTED_MODULE_1__.g)(theme, meeting);
      if (this.config === _default_ui_config_e3c1cd21_js__WEBPACK_IMPORTED_MODULE_4__.d) {
      ...
      if (meeting.connectedMeetings.supportsConnectedMeetings &&
        ((_a = _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.activeBreakoutRoomsManager) === null || _a === void 0 ? void 0 : _a.destinationMeetingId)) {
    ...
    if ((0,_livestream_8c64d895_js__WEBPACK_IMPORTED_MODULE_9__.a)(meeting)) {
    ...
    if (meeting.self.roomJoined) {
      ...
      if (this.showSetupScreen && this.newMeeting == null) {
        ...
        _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.meeting = 'setup';
      }
      else {
  ...
  async iconPackUrlChanged(url) {
    this.iconPack = await (0,_size_6e369dfd_js__WEBPACK_IMPORTED_MODULE_2__.g)(url);
  }
  listenState(e) {
    e.stopPropagation();
  ...
  initializePreferences() {
    const prefs = (0,_user_prefs_f52d234f_js__WEBPACK_IMPORTED_MODULE_6__.g)();
    this.setStates({ prefs });
    _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.prefs = prefs;
  }
  handleChangingMeeting(destinationMeetingId) {
    _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.activeBreakoutRoomsManager = Object.assign(Object.assign({}, _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s.activeBreakoutRoomsManager), { destinationMeetingId });
  }
  handleResize() {
    this.size = (0,_size_6e369dfd_js__WEBPACK_IMPORTED_MODULE_2__.a)(this.host.clientWidth);
  }
  setStates(states) {
    const newStates = Object.assign({}, this.states);
    (0,_config_ab9d504f_js__WEBPACK_IMPORTED_MODULE_1__.m)(newStates, states);
  ...
  render() {
    ...
    const defaults = {
      ...
      size: this.size,
      states: this.states || _store_56e792d0_js__WEBPACK_IMPORTED_MODULE_7__.s,
      config: this.config,
    ...
    if (((_c = (_b = this.meeting) === null || _b === void 0 ? void 0 : _b.meta) === null || _c === void 0 ? void 0 : _c.viewType) === 'CHAT')
      return (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-chat", defaults: defaults });
    return (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_5__.R, { element: "dyte-meeting", defaults: defaults, asHost: true, elementProps: elementProps });
  }
...
const loadModule = (cmpMeta, hostRef, hmrVersionId) => {
    ...
    if (!hmrVersionId || !BUILD.hotModuleReplacement) {
      ...
      switch(bundleId) {
        ...
        case 'dyte-icon':
          return __webpack_require__.e(/* import() */ 8888).then(__webpack_require__.bind(__webpack_require__, 27665)).then(processMod, consoleError);
      }
    }
