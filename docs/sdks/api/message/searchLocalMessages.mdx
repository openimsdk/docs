...
| 参数名称             | 参数类型                                                             | 是否必填 | 描述                                                                                            |
| -------------------- | -------------------------------------------------------------------- | -------- | ----------------------------------------------------------------------------------------------- |
| cb | [OnSearchLocalMessagesCallback](docs/sdks/callback/OnSearchLocalMessagesCallback.mdx) | 是       | 回调接口                                                                                        |
| searchParam | [SearchLocalMessagesParams](docs/sdks/class/message/SearchLocalMessagesParams.mdx) | 是       | 搜索参数 |
