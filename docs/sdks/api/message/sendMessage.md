...
需要先调用createXXXMessage创建一条消息，createXXXMessageByURL创建的消息需要通过[sendMessageNotOss](/api/message/sendMessageNotOss.md)发送。   
**相关回调**：      
...
| offlinePushInfo | [OfflinePushInfo](/class/message/offlinePushInfo.md) | 否       | 离线消息体          |
...
| offlinePushInfo | [OIMOfflinePushInfo](/class/message/offlinePushInfo.md) | 否       | 离线消息体          |
...
| recvID          | string                                                         | 是       | 接收消息的 user ID，发送群消息时传空字符串              |
| groupID         | string                                                         | 是       | 接收消息的 group ID，发送单聊消息时传空字符串           |
| offlinePushInfo | [OfflinePushInfo](/class/message/offlinePushInfo.md) | 是       | 离线消息体                                              |
