...
| 字段名称            | 字段类型                            | 是否必填 | 描述                                                                 |
| ------------------- | ----------------------------------- | -------- | -------------------------------------------------------------------- |
| platformID          | [int](/enum/platform.md) | 是       | 平台号: iOS 1, Android 2, Windows 3, OSX 4, WEB 5, 小程序 6，linux 7 |
...
| 字段名称            | 字段类型                                    | 是否必填 | 描述                                                                 |
| ------------------- | ------------------------------------------- | -------- | -------------------------------------------------------------------- |
| platformID          | [OIMPlatform](/enum/platform.md) | 是       | 平台号: iOS 1, Android 2, Windows 3, OSX 4, WEB 5, 小程序 6，linux 7 |
| apiAddr             | NSString                                    | 是       | IM api 地址，一般为`http://xxx:10002`或`https://xxx/api`             |
| wsAddr              | NSString                                    | 是       | IM ws 地址，一般为`ws://xxx:10001`或`wss://xxx/msg_gateway`          |
...
| 字段名称            | 字段类型                                 | 是否必填 | 描述                                                                 |
| ------------------- | ---------------------------------------- | -------- | -------------------------------------------------------------------- |
| platformID          | [Platform](/enum/platform.md) | 是       | 平台号: iOS 1, Android 2, Windows 3, OSX 4, WEB 5, 小程序 6，linux 7 |
| apiAddr             | string                                   | 是       | IM api 地址，一般为`http://xxx:10002`或`https://xxx/api`             |
| wsAddr              | string                                   | 是       | IM ws 地址，一般为`ws://xxx:10001`或`wss://xxx/msg_gateway`          |
| dataDir             | string                                   | 是       | IM 客户端 DB 存放目录                                                |
