...
| :-------------: | :------: | :----: | :----------------------------------------------- |
|   sourcePath    |   Yes    | string | Full path of the image file on the local machine |
...
|      uuid       |   Yes    | string | Unique ID of the image file                      |
|      type       |   Yes    | string | Image file type                                  |
|      size       |   Yes    |  int   | Image file size                                  |
...
| dataSize  |   Yes    |  int   | Audio file size              |
| duration  |   Yes    |  int   | Audio duration               |
| soundType |   Yes    | string | Audio file type              |
...
|    snapshotUrl      |    No    | string | Video thumbnail image file download URL |
|   snapshotWidth     |    No    |  int   | Video thumbnail image width |
|   snapshotHeight    |    No    |  int   | Video thumbnail image height |
...
| sourceUrl |    No    | string | File download URL |
