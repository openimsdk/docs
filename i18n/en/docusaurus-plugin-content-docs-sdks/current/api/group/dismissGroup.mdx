...
try {
  ...
  await OpenIMSDKRN.dismissGroup(groupID, operationID);

  console.log("dismissGroup: Group", groupID, "dismissed");
} catch (error) {
  console.error('Error dismissGroup:', error);
}
