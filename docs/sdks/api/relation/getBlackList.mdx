...
| 参数名称 | 参数类型                                            | 描述     |
| -------- | --------------------------------------------------- | -------- |
| ~        | List<[BlacklistInfo](docs/sdks/class/relation/blackInfo.mdx)> | 成功返回 |
...
| 参数名称  | 参数类型                                                           | 描述     |
| --------- | ------------------------------------------------------------------ | -------- |
| onSuccess | NSArray< [OIMBlackInfo](docs/sdks/class/relation/blackInfo.mdx) \* > | 成功返回 |
...
| 参数名称        | 参数类型                                                                      | 描述               |
| --------------- | ----------------------------------------------------------------------------- | ------------------ |
| Promise.then()  | Promise<WsResponse<[BlackUserItem](docs/sdks/class/relation/blackInfo.mdx)[]>\> | 黑名单信息对象列表 |
...
| 参数名称 | 参数类型                                                                                     | 是否必填 | 描述     |
| -------- | -------------------------------------------------------------------------------------------- | -------- | -------- |
| cb |  [OnBase](docs/sdks/callback/onBase.mdx)<List<[BlackInfo](docs/sdks/class/relation/blackInfo.mdx)>> | 是       | 回调|
