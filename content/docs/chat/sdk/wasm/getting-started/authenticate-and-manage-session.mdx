...
To refresh a token, request a new `userID`, token, and service addresses from the trusted backend, then call `login()` again or direct the user to sign in according to your product policy.
