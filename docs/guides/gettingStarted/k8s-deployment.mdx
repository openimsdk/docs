...
OpenIM 支持多种集群部署方法，包括但不限于`helm`、`sealos`、`kustomize`。

多个贡献者和之前的官方版本都提供了一些可供参考的解决方案：

- [k8s-jenkins 仓库](https://github.com/openimsdk/k8s-jenkins)
- [open-im-server-k8s-deploy 仓库](https://github.com/openimsdk/open-im-server-k8s-deploy)
- [openim-charts 仓库](https://github.com/openimsdk/openim-charts)
- [deploy-openim 仓库](https://github.com/showurl/deploy-openim)
