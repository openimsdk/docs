...
| Parameter Name  | Data Type                                                                    | Description                 |
| --------------- | ----------------------------------------------------------------------------- | ---------------------------- |
| Promise.then()  | Promise<WsResponse<[PublicInfo](/class/user/publicInfo.mdx)[]>\> | List of retrieved user information |
...
| Parameter Name  | Data Type                                                          | Description                 |
| --------------- | ------------------------------------------------------------------- | ---------------------------- |
| Promise.then()  | Promise<[PublicInfo](/class/user/publicInfo.mdx)[]\> | List of retrieved user information |
...
| -------- | -------------------------------------------------------------------------------------------- | -------- | ------------ |
| cb | [OnFullUserInfoWithCacheList](/callback/OnFullUserInfoWithCacheList.mdx) |Yes      | Callback     |
