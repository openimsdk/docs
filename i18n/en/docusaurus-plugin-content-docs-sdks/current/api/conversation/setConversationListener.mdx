...
| 参数名称 | 参数类型                                                            | 描述 |
| -------- | ------------------------------------------------------------------- | ---- | --- |
| listener | [ConversationListener](/listener/conversationListener.mdx) | 是   |     |
...
| 参数名称 | 参数类型                                                                   | 描述 |
| -------- | -------------------------------------------------------------------------- | ---- | --- |
| listener | id < [ConversationListener](/listener/conversationListener.mdx) > | 是   |     |
...
登录成功后自动设置，可以直接在客户端使用监听，[会话事件详情参见](/listener/conversationListener.mdx)
...
初始化成功后自动设置 回调会通过`globalEvent`传递到客户端，[会话事件详情参见](/listener/conversationListener.mdx)
