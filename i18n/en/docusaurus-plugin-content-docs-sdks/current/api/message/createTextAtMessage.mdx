...
| atUserInfoList | List<[AtUserInfo](/class/message/atInfo.mdx)> | 是       | @人的用户信息列表 |
| quoteMessage   | [Message](/class/message/messageInfo.mdx)     | 是       | 引用的消息        |
...
| atUsersInfo | NSArray< [OIMAtInfo](/class/message/atInfo.mdx) \* > | 是       | @人的用户信息列表 |
| msg         | [OIMMessageInfo](/class/message/messageInfo.mdx)     | 是       | 引用的消息        |
...
| msg         | [OIMMessageInfo](/class/message/messageInfo.mdx) | 否       | 引用的消息 |
...
| atUsersInfo  | [AtUsersInfoItem](/class/message/atInfo.mdx)[] | 是       | @人的用户信息列表 |
| message      | [MessageItem](/class/message/messageInfo.mdx)  | 是       | 引用的消息        |
