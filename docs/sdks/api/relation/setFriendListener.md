...
| 参数名称 | 参数类型                                                          | 是否必填 | 描述 |
| -------- | ----------------------------------------------------------------- | -------- | ---- |
| listener | [OnFriendshipListener](/listener/friendshipListener.md) | 是       |      |
...
| 参数名称 | 参数类型                                                                  | 是否必填 | 描述 |
| -------- | ------------------------------------------------------------------------- | -------- | ---- |
| listener | id < [OIMFriendshipListener](/listener/friendshipListener.md) > | 是       |      |
...
| 参数名称 | 参数类型                                                               | 是否必填 | 描述 |
| -------- | ---------------------------------------------------------------------- | -------- | ---- |
| listener | id <[OnFriendshipListener](/listener/friendshipListener.md)> | 是       |      |
...
登录成功后自动设置，可以直接在客户端使用监听，[好友事件详情参见](/listener/friendshipListener.md)
...
初始化成功后自动设置 回调会通过`globalEvent`传递到客户端，[好友事件详情参见](/listener/friendshipListener.md)
...
| 参数名称 | 参数类型                          | 是否必填 | 描述 |
| -------- | -------------------------------- | -------- | ---- |
| listener | [IFriendShipListener](/listener/friendshipListener.md)              | 是       |      |
