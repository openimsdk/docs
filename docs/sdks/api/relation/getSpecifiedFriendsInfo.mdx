...
public void getFriendsInfoByFilterBlack(OnBase<List<UserInfo>> base, List<String> uidList, Boolean filterBlack)
```
...
```java showLineNumbers
OpenIMClient.getInstance().friendshipManager.getFriendsInfoByFilterBlack(new OnBase<List<UserInfo>>() {
    @Override
...
| 参数名称        | 参数类型                                                                        | 描述         |
| --------------- | ------------------------------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<WsResponse<[PublicInfo](docs/sdks/class/user/publicInfo.mdx)[]>\> | 好友信息列表 |
...
| 参数名称        | 参数类型                                                            | 描述         |
| --------------- | ------------------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<[PublicInfo](docs/sdks/class/user/publicInfo.mdx)[]\> | 好友信息列表 |
