...
OpenIM 不同于 Telegram、Signal、Rocket.Chat 等独立聊天应用，它为开发者提供了一套专门设计的开源即时通讯工具和服务。
...
- OpenIMServer 提供了REST API供业务系统使用，例如通过建立群组、发送推送消息等。REST API以APP管理员超级权限调用，旨在赋予业务更多功能。
