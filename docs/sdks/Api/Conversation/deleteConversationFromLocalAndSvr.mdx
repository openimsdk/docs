...
```dart showLineNumbers
    await OpenIM.iMManager.conversationManager.deleteConversationFromLocalAndSvr(conversationID: conversationID);
    //todo
```
...
[OIMManager.manager deleteConversationFromLocalAndSvr:@""
