...
| 参数名称  | 参数类型                                                                 | 描述     |
| --------- | ------------------------------------------------------------------------ | -------- |
| onSuccess | NSArray< [OIMFullUserInfo](docs/sdks/Class/Friend/FullUserInfo.mdx) \* > | 成功返回 |
...
| 参数名称        | 参数类型                                                                | 描述                 |
| --------------- | ----------------------------------------------------------------------- | -------------------- |
| Promise.then()  | Promise<WsResponse<[FullUserInfo](docs/sdks/Class/User/UserInfo.mdx)>\> | 查询到的用户信息列表 |
...
| 参数名称        | 参数类型                                                         | 描述                 |
| --------------- | ---------------------------------------------------------------- | -------------------- |
| Promise.then()  | Promise<FullUserInfo[]\>                                         | 查询到的用户信息列表 |
