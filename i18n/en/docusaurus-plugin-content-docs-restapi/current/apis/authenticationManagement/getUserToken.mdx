---
sidebar_position: 2
title: Administrator Obtains User Token
hide_title: true
---

<center>

## Administrator Obtains User Token
...
|userID|Required|string|User ID or administrator ID, to generate an administrator token, `imAdmin` must be filled in|
