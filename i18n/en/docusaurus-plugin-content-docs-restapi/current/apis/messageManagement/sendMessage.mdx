...
| senderPlatformID       | Optional | int      | Sender’s [platform type](docs/restapi/commonFields.mdx/#通用字段说明), value from 1-9 |
| content                | Required | object   | Message content; refer to [Message Type Format Description](docs/restapi/contentDescription.mdx/#content-具体内容-) |
...
| sessionType            | Required | int      | [Conversation type](docs/restapi/commonFields.mdx/#通用字段说明)           |
