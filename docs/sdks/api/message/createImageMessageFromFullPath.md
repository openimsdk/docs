...
Web端建议使用[createImageMessageByURL](/api/message/createImageMessageByURL.md)或[createImageMessageByFile](/api/message/createImageMessageByFile.md)。
