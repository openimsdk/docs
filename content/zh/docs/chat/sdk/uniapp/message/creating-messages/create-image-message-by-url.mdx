...
| 参数 | 类型 | 说明 |
| --- | --- | --- |
| `sourcePicture` | <code>OpenIMPicture &#124; null</code> | 原图信息。 |
| `bigPicture` | <code>OpenIMPicture &#124; null</code> | 大图信息。 |
| `snapshotPicture` | <code>OpenIMPicture &#124; null</code> | 缩略图信息。 |
| `sourcePath` | <code>string &#124; null</code> | 原始文件的本地名称或业务路径；只有远端资源时传空字符串。 |
