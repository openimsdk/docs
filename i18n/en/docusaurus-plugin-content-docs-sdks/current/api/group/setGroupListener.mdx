...
| 参数名称 | 参数类型                                                | 描述 |
| -------- | ------------------------------------------------------- | ---- | --- |
| listener | [OnGroupListener](/listener/groupListener.mdx) | 是   |     |
...
| 参数名称 | 参数类型                                                     | 描述 |
| -------- | ------------------------------------------------------------ | ---- | --- |
| listener | id < [GroupListener](/listener/groupListener.mdx) > | 是   |     |
...
| 参数名称 | 参数类型                                                | 是否必填 | 描述     |
| -------- | ------------------------------------------------------- | -------- | -------- |
| listener | [OnGroupListener](/listener/groupListener.mdx) | 是       | 回调接口 |
...
登录成功后自动设置，可以直接在客户端使用监听，[群组事件详情参见](/listener/groupListener.mdx)
...
初始化成功后自动设置 回调会通过`globalEvent`传递到客户端，[群组事件详情参见](/listener/groupListener.mdx)
