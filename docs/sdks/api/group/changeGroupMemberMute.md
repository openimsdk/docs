...
| seconds  | int      | 是       | 要禁言的时长，单位秒。为 0 时取消禁言 |
...
| userID       | NSString  | 是       | 被禁言的用户 ID                    |
| mutedSeconds | NSInteger | 是       | 要禁言的时长，单位秒。为 0 时取消禁言 |
...
| mutedSeconds  | int | 是       | 禁言时长， 0 时取消禁言 |
