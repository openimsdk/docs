...
| recvID          | string                                                         | Yes       | 接收消息的 user ID，发送群消息时传空字符串              |
| groupID         | string                                                         | Yes       | 接收消息的 group ID，发送单聊消息时传空字符串           |
| offlinePushInfo | [OfflinePushInfo](docs/sdks/class/message/offlinePushInfo.mdx) | Yes       | 离线消息体                                              |
