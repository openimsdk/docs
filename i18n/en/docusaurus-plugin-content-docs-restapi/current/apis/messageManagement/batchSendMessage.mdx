...
| senderPlatformID   | Optional | int     | Sender's [platform type](docs/restapi/commonFields/#通用字段说明).                           |
...
| sessionType        | Required | int     | [Session type](docs/restapi/commonFields/#通用字段说明).                                     |
