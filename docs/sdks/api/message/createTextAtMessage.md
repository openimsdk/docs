...
| atUserInfoList | List<[AtUserInfo](/class/message/atInfo.md)> | 是       | @人的用户信息列表 |
| quoteMessage   | [Message](/class/message/messageInfo.md)     | 是       | 引用的消息        |
...
| atUsersInfo | NSArray< [OIMAtInfo](/class/message/atInfo.md) \* > | 是       | @人的用户信息列表 |
| msg         | [OIMMessageInfo](/class/message/messageInfo.md)     | 是       | 引用的消息        |
...
| msg         | [OIMMessageInfo](/class/message/messageInfo.md) | 否       | 引用的消息 |
...
| atUsersInfo  | [AtUsersInfoItem](/class/message/atInfo.md)[] | 是       | @人的用户信息列表 |
| message      | [MessageItem](/class/message/messageInfo.md)  | 是       | 引用的消息        |
...
| -------------- | ------------------------------------------------------ | -------- | ----------------- |
| text           | string                                                 | 是       | 内容              |
| atUserList   | string[]                                          | 是       | @人的 userID 列表 |
| atUsersInfo | [AtInfo](/class/message/atInfo.md) []| 是       | @人的用户信息列表 |
| message   | [Message](/class/message/messageInfo.md)     | 是       | 引用的消息        |
