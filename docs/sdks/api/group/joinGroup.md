...
| reason     | Sting    | 否       | 请求信息                                       |
| joinSource | [int](/enum/joinSource.md)      | 是       | 请求来源 2：通过邀请 3：通过搜索 4：通过二维码 |
...
| joinSource | [OIMJoinType](/enum/joinSource.md) | 是       | 加入途径 |
...
| gid        | String                                  | 是       | 群ID                                          |
| reason     | Sting                                   | 否       | 请求信息                                       |
| joinSource | int                                     | 是       |  [JoinSource](/enum/joinSource.md) 请求来源 |
...
| joinSource | [GroupJoinSource](/enum/joinSource.md) | 是       | 加入途径     |
...
| groupId       | string                                  | 是       | 群ID                                          |
| reqMsg | string                                   | 否       | 请求信息                                       |
| joinSource| [JoinSource](/enum/joinSource.md)                                  | 是       |   请求来源 |
| ex| string| 是       |  扩展字段 |
