...
| content             | object | Specific content of the message, internal json object. For detailed fields, refer to the [Message Type Format Description](restapi/contentDescription.mdx) document |
| contentType         | int    | [Message Type](restapi/contentDescription.mdx)                                           |
