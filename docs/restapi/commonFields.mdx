...
|------------------|----------|--------------------|--------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| secret           | string   | 32                 | OpenIM 秘钥，服务端config/config.yaml 的 secret 字段 | 字符串                                                                                       |
...
| faceURL          | string   | 255                | 头像链接地址                                                 | URL链接                                                                                      |
| ex               | string   | 1024               | 扩展字段，可自行扩展，建议封装成 JSON 字符串                 | 字符串/JSON                                                                                  |
| operationID      | string   |                 | 操作 ID，用于定位问题，保持唯一，建议用当前时间、随机数和userID      | 字符串                                                                                       |
| operatorUserID   | string   | 64                 | 操作者，具体含义是上下文而定                                 | 字符串                                                                                       |
