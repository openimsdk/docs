...
如果会话列表太多，建议使用[getConversationListSplit](/api/conversation/getConversationListSplit.mdx)分页获取。
...
| 名称 | 类型                                                                        | 描述     |
| ---- | --------------------------------------------------------------------------- | -------- |
| ~    | List<[ConversationInfo](/class/conversation/conversationInfo.mdx)> | 成功返回 |
...
| 名称      | 类型                                                                                  | 描述     |
| --------- | ------------------------------------------------------------------------------------- | -------- |
| onSuccess | NSArray< [OIMConversationInfo](/class/conversation/conversationInfo.mdx) \*> | 成功返回 |
...
| 名称     | 类型                                                                                                                 | 描述 |
| -------- | -------------------------------------------------------------------------------------------------------------------- | ---- | -------- |
| callBack | [OnBase](/callback/onBase.mdx)<List<[ConversationInfo](/class/conversation/conversationInfo.mdx)>> | 是   | 回调接口 |
