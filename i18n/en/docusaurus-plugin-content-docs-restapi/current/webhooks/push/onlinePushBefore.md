---
title: Callback Before Online Push Message
hide_title: true
---
...
| --------------- | ------- | ---------------------------------------- |
| callbackCommand | string  | Callback command, here it is the callback before online message push         |
...
| desc            | string  | Description or body content of the push message                 |
| ex              | string  | Additional push information                           |
| iOSPushSound    | string  | Sound used when pushing message on iOS devices           |
| iOSBadgeCount   | boolean | Whether to modify the unread message count on the iOS app icon      |
| signalInfo      | string  | Additional signal data used to pass extra info           |
