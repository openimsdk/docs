...
| Parameter Name      | Parameter Type                                             | Mandatory | Description                                                   |
| ------------- | ---------------------------------------------------- | -------- | ------------------------------------------------------- |
| groupInfo     | Partial<[GroupItem](docs/sdks/class/group/groupInfo.mdx)> | Yes       | Basic group chat information               |
| memberUserIDs | string[]                                             | Yes       | List of invited group members                                    |
| adminUserIDs  | string[]                                             | No       | List of users invited as administrators                              |
| ownerUserID   | string                                               | No       | Group owner ID                                                 |
...
| Parameter Name        | Parameter Type                                                   | Description        |
| --------------- | ---------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<[GroupItem](docs/sdks/class/group/groupInfo.mdx)\> | Callback on successful call |
