...
| ----------- | -------------------------------------------------------- | -------- | ------------------------------------------------------- |
| messageList | [MessageItem](docs/sdks/class/message/messageInfo.mdx)[] | Yes       | 消息列表                                                |
| title       | string                                                   | Yes       | 标题                                                    |
| summaryList | string[]                                                 | Yes       | 消息摘要列表                                            |
...
try {
  const data = await OpenIMSDKRN.createMergerMessage(
    {
      title: '和xx的聊天记录',
      messageList: [
    {
      ...
      summaryList: ["xx: 你好", "xx: 你好"], // Replace with actual summaries
    },
    'operationId'
  );
  console.log("createMergerMessage", data);
} catch (error) {
  console.error('Error createMergerMessage:', error);
}
