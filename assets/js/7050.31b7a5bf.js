...
/* harmony import */ var _grid_93f2f6c8_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(26449);
/* harmony import */ var _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(36677);
...
const DyteSimpleGrid = class {
  ...
  connectedCallback() {
    this.resizeObserver = new _ResizeObserver_es_02979d4e_js__WEBPACK_IMPORTED_MODULE_6__.i(this.setHostDimensions);
  ...
  render() {
    ...
    const { width, height, getPosition } = (0,_grid_93f2f6c8_js__WEBPACK_IMPORTED_MODULE_5__.u)({
      dimensions: this.dimensions,
      count: this.participants.length,
      aspectRatio: this.aspectRatio,
      gap: this.gap,
    });
    return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.participants.map((participant, index) => {
      const { top, left } = getPosition(index);
      return ((0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_37247bff_js__WEBPACK_IMPORTED_MODULE_4__.R, { element: "dyte-participant-tile", defaults: defaults, props: {
          participant,
          style: {
            position: 'absolute',
            top: `${top}px`,
    ...
    }), (0,_index_fbf6e15e_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
