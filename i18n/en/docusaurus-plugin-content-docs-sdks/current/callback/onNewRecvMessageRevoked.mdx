...
| 名称 | 类型                                                   | 描述     |
| ---- | ------------------------------------------------------ | -------- |
| info | [RevokedInfo](/class/message/revokedInfo.mdx) | 撤回信息详情 |
...
| 名称           | 类型                                                             | 描述     |
| -------------- | ---------------------------------------------------------------- | -------- |
| messageRevoked | [OIMMessageRevokedInfo](/class/message/revokedInfo.mdx) | 撤回信息详情 |
...
| 名称 | 类型                                                   | 描述     |
| ---- | ------------------------------------------------------ | -------- |
| info | [RevokedInfo](/class/message/revokedInfo.mdx) | 撤回信息 |
...
| 名称 | 类型                                                                                            | 描述         |
| ---- | ----------------------------------------------------------------------------------------------- | ------------ |
| data | [WSEvent](/class/response.mdx)<[RevokedInfo](/class/message/revokedInfo.mdx)> | 撤回信息详情 |
