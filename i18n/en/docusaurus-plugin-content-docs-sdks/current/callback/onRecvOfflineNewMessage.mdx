...
| 名称 | 类型                                                     | 描述       |
| ---- | -------------------------------------------------------- | ---------- |
| msg  | [Message](/class/message/messageInfo.mdx) | 新离线消息 |
...
| 名称 | 类型                                                     | 描述       |
| ---- | -------------------------------------------------------- | ---------- |
| msg  | List<[Message](/class/message/messageInfo.mdx)> | 新离线消息 |
...
| 名称 | 类型                                                                                            | 描述       |
| ---- | ----------------------------------------------------------------------------------------------- | ---------- |
| data | [WSEvent](/class/response.mdx)<[MessageItem](/class/message/messageInfo.mdx)> | 新离线消息 |
