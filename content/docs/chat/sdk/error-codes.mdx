...
5. If `10005`, `10006`, or decoding errors persist, retain complete logs and follow the platform guide for [WASM logging](/sdk/wasm/logger), [iOS logging](/sdk/ios/logger), [Flutter logging](/sdk/flutter/logger), or [Electron log upload](/sdk/electron/logger/upload-logs).
