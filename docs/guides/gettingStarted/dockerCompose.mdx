...
- 编辑 `docker-compose.yaml` 并注释掉 mysql 配置。
...
新版 Docker 已经整合了 docker-compose。老版本的 Docker 可能不支持 gateway 功能。我们建议您升级到较新的版本，例如 `23.0.1`。升级教程可参考：[点击这里](https://segmentfault.com/a/1190000042702027)。
