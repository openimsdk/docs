...
| -------- | -------------------------------------------------- | -------- | ------------ |
| text     | String                                             | 是       | 文本内容     |
| quoteMsg | [Message](/class/message/messageInfo.mdx) | 是       | 被引用的消息 |
...
| message  | [OIMMessageInfo](/class/message/messageInfo.mdx) | 是       | 被引用的消息 |

### 返回结果

| 名称 | 类型                                                      | 描述     |
| ---- | --------------------------------------------------------- | -------- |
| msg  | [OIMMessageInfo](/class/message/messageInfo.mdx) | 成功返回 |
...
| -------- | ------------------------------------------------------ | -------- | ---------- |
| text     | string                                                 | 是       | 文本内容   |
| message  | [MessageItem](/class/message/messageInfo.mdx) | 是       | 被引用消息 |
