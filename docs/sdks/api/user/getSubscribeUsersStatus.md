...
| 参数名称 | 参数类型              | 描述         |
| -------- | --------------------- | ------------ |
| then     | List<[UserStatusInfo](/class/user/userStatusInfo.md) > | 调用成功回调 |
...
| 参数名称  | 参数类型                                             | 描述     |
| --------- | ---------------------------------------------------- | -------- |
| onSuccess | NSArray<[OIMUserStatusInfo](/class/user/userStatusInfo.md) *>      | 成功返回 |
...
| 参数名称 | 参数类型                                                                                                    | 描述         |
| -------- | ----------------------------------------------------------------------------------------------------------- | ------------ |
| callBack | [OnBase](/callback/onBase.md)<List<[UsersOnlineStatus](/class/user/userStatusInfo.md)>> | 调用成功回调 |
...
| 参数名称 | 参数类型                                                                                                    | 描述         |
| -------- | ----------------------------------------------------------------------------------------------------------- | ------------ |
| cb | [OnBase](/callback/onBase.md)<List<[UsersOnlineStatus](/class/user/userStatusInfo.md)>>| 回调|
