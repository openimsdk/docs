...
⚠️ **Note**: OpenIMServer has three built-in APP administrators, and their `userID` are as follows:
> - `openIM123456`
> - `openIM654321`
> - `openIMAdmin`
...
| userID       | Required | string | Regular userID or administrator userID, such as when generating an administrator token, you need to enter one of the following: `openIM123456`, `openIM654321`, or `openIMAdmin`.                                                  |
