...
| ----------- | ------ | ------------------ | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| secret      | string | 32                 | OpenIM 秘钥，登录注册 IM 用户的时候需要用到，服务端配置文件 config.yaml 的 secret 字段 | 字符串                                                                                                  |
| platformID  | int    |                    | 用户登录时的终端类型                                                                   | 1：iOS、2：Android、3：Windows、4：OSX、5：WEB、6：小程序、7：linux、8：Android Pad、9：IPad、10：Admin |
| userID      | string | 64                 | 用户 ID，保证 IM 内唯一                                                                | 字符串即可                                                                                              |
...
| appMangerLevel | int    |                    | 该字段无意义，暂未删除 |                                                        |
