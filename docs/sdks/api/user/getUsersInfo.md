...
| 参数名称 | 参数类型        | 描述         |
| -------- | --------------- | ------------ |
| then     | List< [PublicUserInfo](/class/user/publicInfo.md) \> | 调用成功回调 |
...
| 参数名称  | 参数类型                                             | 描述     |
| --------- | ---------------------------------------------------- | -------- |
| onSuccess | [OIMPublicUserInfo](/class/user/publicInfo.md)                                  | 成功返回 |
...
| 参数名称 | 参数类型                                                                                     | 是否必填 | 描述         |
| -------- | -------------------------------------------------------------------------------------------- | -------- | ------------ |
| callBack | [OnBase](/callback/onBase.md)<List<[PublicUserInfo](/class/user/publicInfo.md)>> | 是       | 回调接口     |
...
| 参数名称        | 参数类型                                                                      | 描述                 |
| --------------- | ----------------------------------------------------------------------------- | -------------------- |
| Promise.then()  | Promise<WsResponse<[PublicUserItem](/class/user/publicInfo.md)[]>\> | 查询到的用户信息列表 |
...
| 参数名称        | 参数类型                                                          | 描述                 |
| --------------- | ----------------------------------------------------------------- | -------------------- |
| Promise.then()  | Promise<[PublicUserItem](/class/user/publicInfo.md)[]\> | 查询到的用户信息列表 |
...
| 参数名称 | 参数类型                                                                                     | 是否必填 | 描述         |
| -------- | -------------------------------------------------------------------------------------------- | -------- | ------------ |
| cb | [OnBase](/callback/onBase.md)<List<[PublicUserInfo](/class/user/publicInfo.md)>>  | 是       |   回调 |
