...
| Parameter Name        | Data Type                                                                   | Description  |
| --------------- | ---------------------------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<WsResponse<[PublicInfo](/class/user/publicInfo.mdx)[]>\> | List of friend information |
...
| Parameter Name        | Data Type                                                            | Description  |
| --------------- | ------------------------------------------------------------------- | ------------ |
| Promise.then()  | Promise<[PublicInfo](/class/user/publicInfo.mdx)[]\> | List of friend information |
