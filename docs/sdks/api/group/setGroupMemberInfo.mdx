...
| 参数名称         | 参数类型                                                        | 是否必填 | 描述     |
| ---------------- | --------------------------------------------------------------- | -------- | -------- |
| groupMembersInfo | [SetGroupMembersInfo](docs/sdks/class/group/SetGroupMemberInfo.mdx) | 是       | 成员信息 |
...
| 参数名称         | 参数类型                                                        | 是否必填 | 描述     |
| ---------------- | --------------------------------------------------------------- | -------- | -------- |
| groupMembersInfo | [OIMSetGroupMembersInfo](docs/sdks/class/group/SetGroupMemberInfo.mdx) | 是       | 成员信息 |
