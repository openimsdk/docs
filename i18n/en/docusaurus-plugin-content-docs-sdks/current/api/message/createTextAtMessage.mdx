...
| ------------ | ------------------------------------------------------- | -------- | ------------------------------------------------------- |
| text         | string                                                  | Yes       | 内容                                                    |
| atUserIDList | string[]                                                | Yes       | @人的 userID 列表                                       |
| atUsersInfo  | [AtUsersInfoItem](docs/sdks/class/message/atInfo.mdx)[] | Yes       | @人的用户信息列表                                       |
| message      | [MessageItem](docs/sdks/class/message/messageInfo.mdx)  | Yes       | 引用的消息                                              |
