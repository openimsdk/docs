---
title: "Cancel mute group"
description: "Cancel mute group with the OpenIM Platform API, including endpoint, request body, response fields, and error handling."
...
version: "v3"
sourcePath: "/platform-api/group/group-moderation/cancel-mute-group"
---

Use **Cancel mute group** to remove the group-wide mute state.

## HTTP request

```bash
POST {API_ADDRESS}/group/cancel_mute_group
```

### Request example

```bash
curl --request POST "${API_ADDRESS}/group/cancel_mute_group" \
