...
一次性获取自己所有的好友列表，建议使用`getFriendListPage`分页获取。
...
| 参数名称 | 参数类型                                            | 描述     |
| -------- | --------------------------------------------------- | -------- |
| ~        | List< [FriendInfo](/class/relation/friendInfo.md) \* > | 成功返回 |
...
| 参数名称  | 参数类型                                                             | 描述     |
| --------- | -------------------------------------------------------------------- | -------- |
| onSuccess | NSArray< [OIMFriendInfo](/class/relation/friendInfo.md) \* > | 成功返回 |
...
| 参数名称 | 参数类型                                            | 描述     |
| -------- | --------------------------------------------------- | -------- |
| data     | List\<[UserInfo](/class/user/userInfo.md)> | 成功返回 |
...
| 参数名称    | 参数类型 | 是否必填 | 描述                                                    |
| ----------- | -------- | -------- | ------------------------------------------------------- |
| filterBlack  | boolean | 否       | 是否过滤被拉黑的好友，默认不过滤                                        |
...
| 参数名称        | 参数类型                                                                        | 描述             |
| --------------- | ------------------------------------------------------------------------------- | ---------------- |
| Promise.then()  | Promise<WsResponse<[FriendUserItem](/class/relation/friendInfo.md)[]>\> | 好友信息对象列表 |
...
| 参数名称        | 参数类型                                                            | 描述             |
| --------------- | ------------------------------------------------------------------- | ---------------- |
| Promise.then()  | Promise<[FriendUserItem](/class/relation/friendInfo.md)[]\> | 好友信息对象列表 |
