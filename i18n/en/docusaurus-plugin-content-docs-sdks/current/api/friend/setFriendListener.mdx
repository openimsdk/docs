...
After successful initialization, it's set automatically. You can directly use the listener on the client side. [Details on friendship events can be found here](/listener/friendshipListener.mdx)
...
| -------- | -------------------------------- | -------- | ---- |
| listener | [IFriendShipListener](/listener/friendshipListener.mdx)              |Yes      |      |
