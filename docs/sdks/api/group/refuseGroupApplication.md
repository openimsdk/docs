...
| userID    | Sting    | 是       | 申请者 userID   |
| handleMsg | Sting    | 否       | 拒绝原因          |
...
| fromUserID | NSSting  | 是       | 申请者 userID   |
| handleMsg  | NSSting  | 否       | 拒绝原因    |
