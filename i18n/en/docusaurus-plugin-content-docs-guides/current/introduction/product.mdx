...
> 📢 **Note**: OpenIMSDK does not integrate a UI interface, and OpenIM Server does not provide user registration and login functionality. This means it is not a complete IM product.
...
## 🔍 Detailed Explanation of OpenIM Server
...
[🔗 OpenIM Server Repository Link](https://github.com/openimsdk/open-im-server)
