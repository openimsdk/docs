...
| 参数名称        | 参数类型                                                                            | 描述                 |
| --------------- | ----------------------------------------------------------------------------------- | -------------------- |
| Promise.then()  | Promise<WsResponse<[FriendshipInfo](docs/sdks/Class/Friend/FriendshipInfo.mdx)[]>\> | 好友关系结果信息列表 |
...
| 参数名称        | 参数类型                                                                | 描述                 |
| --------------- | ----------------------------------------------------------------------- | -------------------- |
| Promise.then()  | Promise<[FriendshipInfo](docs/sdks/Class/Friend/FriendshipInfo.mdx)[]\> | 好友关系结果信息列表 |
