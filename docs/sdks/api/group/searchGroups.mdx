...
| isSearchGroupID   | bool          | 是       | 是否以关键词搜索群聊 ID  |
...
| OIMSearchGroupParam.isSearchGroupID   | BOOL                  | 否 |是否以关键词搜索群聊 ID(注：两个不可以同时为 false)，默认 false |
...
| isSearchGroupID   | Boolean                                                                                         | 是       | 检索群聊 ID  |
...
| isSearchGroupID   | boolean  | 是       | 是否以关键词搜索群聊 ID                          |
