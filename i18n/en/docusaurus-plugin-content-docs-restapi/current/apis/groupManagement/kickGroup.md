...
### Brief Description
- Remove group member from the group. If the group owner needs to be removed, the group ownership needs to be transferred to another member first.
### Request Method
- `post` 
### Request URL
...
| kickedUserIDs | Required | array | Kicked user ID list |
| reason | Optional | string | Removed reason |
