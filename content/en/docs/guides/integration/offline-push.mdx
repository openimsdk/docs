In mobile environments, the situation is more complex: when the user is offline, or the app is killed or sent to the background, the system may suspend the process, preventing the **OpenIMClientSDK long-lived connection** from delivering messages. To ensure timely message delivery, third-party push services are required:
...
- [OpenIMClientSDK Flutter Demo Configuration](https://github.com/openimsdk/openim-flutter-demo/blob/main/CONFIGKEY.zh-CN.md)
- [OpenIMClientSDK iOS Demo Configuration](https://github.com/openimsdk/openim-ios-demo/blob/main/CONFIGKEY.zh-CN.md)
- [OpenIMClientSDK uni-app Demo Configuration](https://github.com/openimsdk/open-im-uniapp-demo/blob/main/CONFIGKEY.md)
- [OpenIMClientSDK Android Demo Configuration](https://github.com/openimsdk/open-im-android-demo/blob/main/CONFIGKEY.zh-CN.md)
