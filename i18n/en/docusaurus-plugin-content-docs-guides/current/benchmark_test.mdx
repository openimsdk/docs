...
![image-20240923164028334](.\assets\br-login.png)

**Message Stress:** (The following graph shows the number of messages received by the server per minute)

![image-20240923164056715](.\assets\br-msg.png)

**CPU Usage:**

![image-20240911154731346](.\assets\br-cpu.png)
...
![image-20240911162850004](.\assets\br-mem.png)
